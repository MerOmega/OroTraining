...
/**
 * @ORM\Entity (repositoryClass="Fantasy\Bundle\DemoBundle\Entity\Repository\OnDeliverySettingsRepository")
 */
class OnDeliverySettings extends Transport
{
    /**
